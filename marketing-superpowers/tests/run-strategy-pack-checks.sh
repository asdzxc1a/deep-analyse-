...
assert_contains "$ROOT/production-board-weeks-1-2.md" "The Audition"
assert_contains "$ROOT/production-board-weeks-1-2.md" "The Reject Pile"
...
assert_contains "$ROOT/scripted-shooting-boards-top-5.md" "she made couture feel alive again"
assert_contains "$ROOT/scripted-shooting-boards-top-5.md" "Protective Tenderness"
assert_contains "$ROOT/scripted-shooting-boards-top-5.md" "The Audition"
